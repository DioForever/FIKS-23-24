...
//             public Instruction(string opcode, Player player)
//             {
//                 this.opcode = opcode;
//                 this.player = player;
//             }
...
//         public Instruction(int opcode, Player player, int reg1, int reg2, string imm)
//         {
//             this.opcode = opcode;
//             this.player = player;
//             this.reg1 = reg1;
...
//             }
//             return $"{opcodeString} {reg1}{reg2} {imm.Replace(" ", "")}";
//         }
//     }
